# An alternative to bb.py that works with Ghidra
# 
...
output_path = "{}/{}".format(os.getcwd(), datetime.now().strftime("bblist_{}_%H_%M_%S.bb".format(currentProgram.getName())))
...
# (this script only outputs data for the first executable section)
